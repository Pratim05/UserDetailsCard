...
function BizStudentTable({ userListData, convertImageUrl }) {
    ...
    <div className="-my-2 dash_width py-2 sm:-mx-6 sm:px-6 lg:-mx-8 pr-10 lg:px-8 ">
      <div className="align-middle rounded-tl-lg rounded-tr-lg inline-block w-3/4 py-4 overflow-hidden bg-white shadow-lg px-12 overflow-x-auto">
        <div className="flex justify-between">
          ...
          <p class="text-2xl font-medium text-gray-900 dark:text-black"> Business Student Data</p>
        </div>
      </div>
        ...
        <table className="w-full">
          <thead className='sticky bg-white'>
            <tr>
              ...
              <th className="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">BUSINESS NAME</th>
              ...
              <th className="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">EMERGENCY NO</th>
...
export default BizStudentTable