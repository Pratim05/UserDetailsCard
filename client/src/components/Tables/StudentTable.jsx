        ...
        <table className="w-full">
          <thead className='sticky bg-white'>
            <tr>
              ...
              <th className="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">SCHOOL</th>
              ...
              <th className="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">GUARDIAN NO</th>
            </tr>
          </thead>
